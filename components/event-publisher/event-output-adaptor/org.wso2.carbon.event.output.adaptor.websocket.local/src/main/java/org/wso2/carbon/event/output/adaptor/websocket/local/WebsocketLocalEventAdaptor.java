...
public class WebsocketLocalEventAdaptor extends AbstractOutputEventAdaptor {
	...
	protected void publish(
			...
			int tenantId) {
        String topic = endpointAdaptorConfiguration.getOutputAdaptorProperties().get(WebsocketLocalEventAdaptorConstants.ADAPTER_TOPIC);
        ...
        CopyOnWriteArrayList<Session> sessions = websocketLocalOutputCallbackRegisterServiceInternal.getSessions(tenantId, endpointAdaptorConfiguration.getEndpointAdaptorName(), topic);
        if (sessions != null){
