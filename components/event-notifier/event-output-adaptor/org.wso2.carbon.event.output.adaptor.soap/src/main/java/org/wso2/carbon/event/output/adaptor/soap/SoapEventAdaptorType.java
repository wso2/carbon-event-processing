...
public final class SoapEventAdaptorType extends AbstractOutputEventAdaptor {
    ...
    public void publish(
        ...
        String url = endpointAdaptorConfiguration.getOutputAdaptorProperties().get(SoapEventAdaptorConstants.ADAPTOR_CONF_SOAP_URL);
        String userName = endpointAdaptorConfiguration.getOutputAdaptorProperties().get(SoapEventAdaptorConstants.ADAPTOR_CONF_SOAP_USERNAME);
        String password = endpointAdaptorConfiguration.getOutputAdaptorProperties().get(SoapEventAdaptorConstants.ADAPTOR_CONF_SOAP_PASSWORD);
        Map<String, String> headers = this.extractHeaders(endpointAdaptorConfiguration.getOutputAdaptorProperties().get(SoapEventAdaptorConstants.ADAPTOR_CONF_SOAP_HEADERS));
    ...
    public void testConnection(
        ...
        try {
            ...
            publish(builder1.getDocumentElement(), endpointAdaptorConfiguration, tenantId);
