...
/**
 * @scr.component name="output.sms.EventAdaptorService.component" immediate="true"
...
public class SMSEventAdaptorServiceDS {
    ...
    protected void activate(ComponentContext context) {
        ...
        try {
            OutputEventAdaptorFactory smsEventAdaptorFactory = new SMSEventAdaptorFactory();
            context.getBundleContext().registerService(OutputEventAdaptorFactory.class.getName(), smsEventAdaptorFactory, null);
            if (log.isDebugEnabled()) {
                log.debug("Successfully deployed the output SMS event adaptor service");
            }
