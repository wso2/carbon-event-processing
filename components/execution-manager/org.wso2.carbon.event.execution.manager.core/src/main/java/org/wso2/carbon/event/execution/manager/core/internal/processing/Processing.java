...
import org.wso2.carbon.event.execution.manager.core.ExecutionManager;
import org.wso2.carbon.event.execution.manager.core.internal.structure.execution.ExecutionPlan;
import org.wso2.carbon.event.execution.manager.core.internal.structure.execution.*;
import org.wso2.carbon.event.execution.manager.core.internal.structure.execution.ObjectFactory;
import org.wso2.carbon.event.execution.manager.core.internal.structure.execution.Stream;
import org.wso2.carbon.event.execution.manager.core.internal.structure.domain.TemplateDomain;
import org.wso2.carbon.event.execution.manager.core.internal.structure.template.*;
...
import org.wso2.carbon.event.execution.manager.core.internal.structure.template.And;
import org.wso2.carbon.event.execution.manager.core.internal.structure.template.Or;
...
public class Processing {
    ...
    public void setAttributes(ExecutionPlan executionPlan,
        ...
        executionGenerator.saveTemplateConfig(fileName, fileContent, templateConfig.getDescription(),
                templateConfig.getFrom());
    ...
    public void setStreams(ExecutionPlan executionPlan,
        ...
        try {
            ...
            List<org.wso2.carbon.event.execution.manager.core.internal.structure.domain.Stream> streamList =
                    templateDomain.getStream();

            for (org.wso2.carbon.event.execution.manager.core.internal.structure.domain.Stream streamTemp : streamList) {
    ...
    public boolean havingANDParent(WiringObject wiringObject) {
        return wiringObject.getParent() != null && (wiringObject.getParent().getName().equals("AND")
                || havingANDParent(wiringObject.getParent()));
    }
    ...
    public String getExecutionPlanContent(ExecutionPlan executionPlan,
        ...
        try {
            ...
            marshaller.setProperty(Marshaller.JAXB_ENCODING, ExecutionManagerConstants.DEFAULT_CHARSET);


            StringWriter stringWriter = new StringWriter();
            PrintWriter printWriter = new PrintWriter(stringWriter);

            DataWriter dataWriter = new DataWriter(printWriter, ExecutionManagerConstants.DEFAULT_CHARSET,
