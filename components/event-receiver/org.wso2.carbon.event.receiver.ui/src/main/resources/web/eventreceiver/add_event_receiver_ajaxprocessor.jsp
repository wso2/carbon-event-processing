...
<%@ page import="org.wso2.carbon.event.receiver.stub.types.BasicOutputAdapterPropertyDto" %>
...
<%
    ...
    try {
        ...
        boolean customMappingEnabled = EventReceiverUIConstants.STRING_LITERAL_ENABLE.equalsIgnoreCase(customMapping);
        ...
        BasicOutputAdapterPropertyDto[] eventReceiverProperties = null;
        ...
        if (outputParameterSet != null && !outputParameterSet.equals("")) {
            ...
            if (properties != null) {
                ...
                eventReceiverProperties = new BasicOutputAdapterPropertyDto[properties.length];
                int index = 0;
                for (String property : properties) {
                    String[] propertyNameAndValue = property.split("\\$=");
                    if (propertyNameAndValue != null) {
                        eventReceiverProperties[index] = new BasicOutputAdapterPropertyDto();
                        eventReceiverProperties[index].setKey(propertyNameAndValue[0].trim());
                        eventReceiverProperties[index].setValue(propertyNameAndValue[1].trim());
                        index++;
                    }
                }
        ...
        if (mappingType.equals("wso2event")) {
            ...
            stub.deployWSO2EventReceiverConfiguration(eventReceiverName, streamNameWithVersion, eventAdapterType, metaWSO2EventConfiguration, correlationWSO2EventConfiguration, payloadWSO2EventConfiguration, eventReceiverProperties, customMappingEnabled);
            msg = "true";
            ...
            // add event adapter via admin service
            stub.deployTextEventReceiverConfiguration(eventReceiverName, streamNameWithVersion, eventAdapterType, dataSet, eventReceiverProperties, dataFrom, customMappingEnabled);
            msg = "true";
            ...
            // add event adapter via admin service
            stub.deployXmlEventReceiverConfiguration(eventReceiverName, streamNameWithVersion, eventAdapterType, dataSet, eventReceiverProperties, dataFrom, customMappingEnabled);
            msg = "true";
            ...
            // add event adapter via admin service
            stub.deployMapEventReceiverConfiguration(eventReceiverName, streamNameWithVersion, eventAdapterType, eventOutputPropertyConfiguration, eventReceiverProperties, customMappingEnabled);
            msg = "true";
            ...
            String dataFrom = request.getParameter("dataFrom");
            // add event adapter via admin service
            stub.deployJsonEventReceiverConfiguration(eventReceiverName, streamNameWithVersion, eventAdapterType, dataSet, eventReceiverProperties, dataFrom, customMappingEnabled);
            msg = "true";
        }
