...
<%
    ...
    String[] outputAdapterTypes = eventReceiverAdminServiceStub.getAllOutputAdapterTypes();
    ...
    if (streamId != null) {
        ...
        if (metaAttributeList != null && metaAttributeList.length > 0) {
            for (EventStreamAttributeDto attribute : metaAttributeList) {
                attributes += EventReceiverUIConstants.PROPERTY_META_PREFIX + attribute.getAttributeName() + " " + attribute.getAttributeType() + ", \n";
            }
        }
        if (correlationAttributeList != null) {
            for (EventStreamAttributeDto attribute : correlationAttributeList) {
                attributes += EventReceiverUIConstants.PROPERTY_CORRELATION_PREFIX + attribute.getAttributeName() + " " + attribute.getAttributeType() + ", \n";
            }
        }
...
<%
    OutputAdapterConfigurationDto outputAdapterConfigurationDto = eventReceiverAdminServiceStub.getOutputAdapterConfigurationSchema(firstEventAdapterType);
        ...
        <table id="noEventBuilderInputTable" class="normal-nopadding"
            ...
            <tr>
                <td class="leftCol-med" colspan="2">Event Streams or Output
                                                    ...
                                                    an Output Event Adapter to continue...
                </td>
            </tr>
            </tbody>
        </table>
