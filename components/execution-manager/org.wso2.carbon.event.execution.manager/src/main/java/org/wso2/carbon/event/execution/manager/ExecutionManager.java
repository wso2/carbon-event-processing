...
import org.wso2.carbon.event.execution.manager.internal.util.ExecutionManagerConstants;
...
public class ExecutionManager {
    ...
    public void saveTemplateConfig(String fileName, String fileContent, String description, String type) {
        ...
        try{
            ...
            String resourcePath = ExecutionManagerConstants.TEMPLATE_CONFIG_PATH + "/" + fileName + ".xml";
    ...
    public String getTemplateConfig(String configName) {
        ...
        try {
            config_file = registry.get(ExecutionManagerConstants.TEMPLATE_CONFIG_PATH + "/" + configName + ".xml");
    ...
    public void deleteTemplateConfig(String configName) {
        ...
        try {
            registry.delete(ExecutionManagerConstants.TEMPLATE_CONFIG_PATH + "/" + configName + ".xml");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
