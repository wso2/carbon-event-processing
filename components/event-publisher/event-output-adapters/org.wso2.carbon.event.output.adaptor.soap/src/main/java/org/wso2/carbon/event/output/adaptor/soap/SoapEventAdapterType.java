...
public final class SoapEventAdapterType extends AbstractOutputEventAdapter {

    private static final Log log = LogFactory.getLog(SoapEventAdapterType.class);
    private static SoapEventAdapterType soapEventAdaptor = new SoapEventAdapterType();
     ...
     */
    public static SoapEventAdapterType getInstance() {
    ...
    public void publish(
        ...
        String url = outputAdaptorConfiguration.getEndpointAdaptorProperties().get(SoapEventAdaptorConstants.ADAPTOR_CONF_SOAP_URL);
        String userName = outputAdaptorConfiguration.getEndpointAdaptorProperties().get(SoapEventAdaptorConstants.ADAPTOR_CONF_SOAP_USERNAME);
        String password = outputAdaptorConfiguration.getEndpointAdaptorProperties().get(SoapEventAdaptorConstants.ADAPTOR_CONF_SOAP_PASSWORD);
        Map<String, String> headers = this.extractHeaders(outputAdaptorConfiguration.getEndpointAdaptorProperties().get(SoapEventAdaptorConstants.ADAPTOR_CONF_SOAP_HEADERS));
    ...
    public void testConnection(
        ...
        try {
            ...
            publish(builder1.getDocumentElement(), outputAdaptorConfiguration, tenantId);

        } catch (XMLStreamException e) {
            throw new EndpointAdaptorProcessingException(e.getMessage());
        }
        ...
        public void run() {
            ...
            try {
                ...
                try {
                    ...
                    throw new EndpointAdaptorProcessingException("Exception while sending events to soap endpoint ", axisFault);
                } catch (XMLStreamException e) {
                    throw new EndpointAdaptorProcessingException("Exception while converting the event to xml object ", e);
                } catch (Exception e) {
                    throw new EndpointAdaptorProcessingException(e.getMessage(), e);
                }
            } catch (AxisFault axisFault) {
                throw new EndpointAdaptorProcessingException(axisFault.getMessage(), axisFault);
            }
