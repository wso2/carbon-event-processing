...
public class EventPublisherConfigurationException extends Exception {
    ...
    public EventPublisherConfigurationException(String message) {
        super(message);
    }

    public EventPublisherConfigurationException(String message, Throwable cause) {
        super(message, cause);
    }

    public EventPublisherConfigurationException(Throwable cause) {
        super(cause);
    }
}
