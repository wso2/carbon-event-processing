...
public final class EmailEventAdaptorType extends AbstractOutputEventAdaptor {
    ...
    private ConcurrentHashMap<EndpointAdaptorConfiguration, EmailSenderConfiguration> emailSenderConfigurationMap = new ConcurrentHashMap<EndpointAdaptorConfiguration, EmailSenderConfiguration>();
    ...
    public void publish(
        ...
        EmailSenderConfiguration emailSenderConfiguration = emailSenderConfigurationMap.get(endpointAdaptorConfiguration);
        if (emailSenderConfiguration == null) {
            emailSenderConfiguration = new EmailSenderConfiguration(endpointAdaptorConfiguration);
            emailSenderConfigurationMap.putIfAbsent(endpointAdaptorConfiguration, emailSenderConfiguration);
        }
    ...
    public void removeConnectionInfo(
            EndpointAdaptorConfiguration endpointAdaptorConfiguration, int tenantId) {
        emailSenderConfigurationMap.remove(endpointAdaptorConfiguration);
    }
    ...
    private final class EmailSenderConfiguration {
        ...
        private EmailSenderConfiguration(
            ...
            subject = endpointAdaptorConfiguration.getOutputAdaptorProperties().get(EmailEventAdaptorConstants.ADAPTOR_MESSAGE_EMAIL_SUBJECT);
            String emailIdString = endpointAdaptorConfiguration.getOutputAdaptorProperties().get(EmailEventAdaptorConstants.ADAPTOR_MESSAGE_EMAIL_ADDRESS);
