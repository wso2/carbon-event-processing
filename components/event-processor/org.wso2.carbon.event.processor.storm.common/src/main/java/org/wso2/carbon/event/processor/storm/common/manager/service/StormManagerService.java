 ...
 */
package org.wso2.carbon.event.processor.storm.common.manager.service;
...
public class StormManagerService {
    ...
    public interface Iface {
        ...
        public void registerStormReceiver(int tenantId, String executionPlanName, String hostName, int port) throws org.wso2.carbon.event.processor.storm.common.manager.service.exception.NotStormManagerException, org.apache.thrift.TException;

        public void registerCEPPublisher(int tenantId, String executionPlanName, String hostName, int port) throws org.wso2.carbon.event.processor.storm.common.manager.service.exception.NotStormManagerException, org.apache.thrift.TException;

        public String getStormReceiver(int tenantId, String executionPlanName, String cepReceiverHostName) throws org.wso2.carbon.event.processor.storm.common.manager.service.exception.NotStormManagerException, org.wso2.carbon.event.processor.storm.common.manager.service.exception.EndpointNotFoundException, org.apache.thrift.TException;

        public String getCEPPublisher(int tenantId, String executionPlanName, String stormPublisherHostName) throws org.wso2.carbon.event.processor.storm.common.manager.service.exception.NotStormManagerException, org.wso2.carbon.event.processor.storm.common.manager.service.exception.EndpointNotFoundException, org.apache.thrift.TException;
    ...
    public static class Client extends org.apache.thrift.TServiceClient implements Iface {
        ...
        public void recv_registerStormReceiver() throws org.wso2.carbon.event.processor.storm.common.manager.service.exception.NotStormManagerException, org.apache.thrift.TException
        {
        ...
        public void recv_registerCEPPublisher() throws org.wso2.carbon.event.processor.storm.common.manager.service.exception.NotStormManagerException, org.apache.thrift.TException
        {
        ...
        public String recv_getStormReceiver() throws org.wso2.carbon.event.processor.storm.common.manager.service.exception.NotStormManagerException, org.wso2.carbon.event.processor.storm.common.manager.service.exception.EndpointNotFoundException, org.apache.thrift.TException
        {
        ...
        public String recv_getCEPPublisher() throws org.wso2.carbon.event.processor.storm.common.manager.service.exception.NotStormManagerException, org.wso2.carbon.event.processor.storm.common.manager.service.exception.EndpointNotFoundException, org.apache.thrift.TException
        {
    ...
    public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
        ...
        public static class registerStormReceiver_call extends org.apache.thrift.async.TAsyncMethodCall {
            ...
            public void getResult() throws org.wso2.carbon.event.processor.storm.common.manager.service.exception.NotStormManagerException, org.apache.thrift.TException {
        ...
        public static class getStormReceiver_call extends org.apache.thrift.async.TAsyncMethodCall {
            ...
            public String getResult() throws org.wso2.carbon.event.processor.storm.common.manager.service.exception.NotStormManagerException, org.wso2.carbon.event.processor.storm.common.manager.service.exception.EndpointNotFoundException, org.apache.thrift.TException {
                if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
                    throw new IllegalStateException("Method call not finished!");
                }
                org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
    ...
    public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor implements org.apache.thrift.TProcessor {
        ...
        private static class registerStormReceiver<I extends Iface> extends org.apache.thrift.ProcessFunction<I, registerStormReceiver_args> {
            ...
            protected registerStormReceiver_result getResult(I iface, registerStormReceiver_args args) throws org.apache.thrift.TException {
                ...
                } catch (org.wso2.carbon.event.processor.storm.common.manager.service.exception.NotStormManagerException nsme) {
                    result.nsme = nsme;
                }
                return result;
            }
        ...
        private static class getStormReceiver<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getStormReceiver_args> {
            ...
            protected getStormReceiver_result getResult(I iface, getStormReceiver_args args) throws org.apache.thrift.TException {
                ...
                try {
                    ...
                    result.nsme = nsme;
                } catch (org.wso2.carbon.event.processor.storm.common.manager.service.exception.EndpointNotFoundException enfe) {
                    result.enfe = enfe;
                }
                return result;
            }
    ...
    public static class registerStormReceiver_result implements org.apache.thrift.TBase<registerStormReceiver_result, registerStormReceiver_result._Fields>, java.io.Serializable, Cloneable   {
        ...
        public org.wso2.carbon.event.processor.storm.common.manager.service.exception.NotStormManagerException nsme; // required
        ...
        public registerStormReceiver_result(
                org.wso2.carbon.event.processor.storm.common.manager.service.exception.NotStormManagerException nsme)
        {
            this();
            this.nsme = nsme;
        }
        ...
        public registerStormReceiver_result(registerStormReceiver_result other) {
            if (other.isSetNsme()) {
                this.nsme = new org.wso2.carbon.event.processor.storm.common.manager.service.exception.NotStormManagerException(other.nsme);
            }
        }
        ...
        public org.wso2.carbon.event.processor.storm.common.manager.service.exception.NotStormManagerException getNsme() {
            return this.nsme;
        }

        public registerStormReceiver_result setNsme(org.wso2.carbon.event.processor.storm.common.manager.service.exception.NotStormManagerException nsme) {
            this.nsme = nsme;
            return this;
        }
            ...
            switch (field) {
                case NSME:
                    if (value == null) {
                        ...
                        setNsme((org.wso2.carbon.event.processor.storm.common.manager.service.exception.NotStormManagerException)value);
                    }
                    break;
                ...
                switch (field.id) {
                    case 1: // NSME
                        if (field.type == org.apache.thrift.protocol.TType.STRUCT) {
                            this.nsme = new org.wso2.carbon.event.processor.storm.common.manager.service.exception.NotStormManagerException();
    ...
    public static class registerCEPPublisher_result implements org.apache.thrift.TBase<registerCEPPublisher_result, registerCEPPublisher_result._Fields>, java.io.Serializable, Cloneable   {
        ...
        public registerCEPPublisher_result setNsme(org.wso2.carbon.event.processor.storm.common.manager.service.exception.NotStormManagerException nsme) {
            this.nsme = nsme;
            return this;
        }
    ...
    public static class getStormReceiver_result implements org.apache.thrift.TBase<getStormReceiver_result, getStormReceiver_result._Fields>, java.io.Serializable, Cloneable   {
        ...
        public org.wso2.carbon.event.processor.storm.common.manager.service.exception.NotStormManagerException nsme; // required
        public org.wso2.carbon.event.processor.storm.common.manager.service.exception.EndpointNotFoundException enfe; // required
        ...
        public getStormReceiver_result(
                String success,
                org.wso2.carbon.event.processor.storm.common.manager.service.exception.NotStormManagerException nsme,
                org.wso2.carbon.event.processor.storm.common.manager.service.exception.EndpointNotFoundException enfe)
        {
            this();
        ...
        public getStormReceiver_result(getStormReceiver_result other) {
            ...
            if (other.isSetEnfe()) {
                this.enfe = new org.wso2.carbon.event.processor.storm.common.manager.service.exception.EndpointNotFoundException(other.enfe);
            }
        }
        ...
        public getStormReceiver_result setNsme(org.wso2.carbon.event.processor.storm.common.manager.service.exception.NotStormManagerException nsme) {
            this.nsme = nsme;
            return this;
        }
        ...
        public org.wso2.carbon.event.processor.storm.common.manager.service.exception.EndpointNotFoundException getEnfe() {
            return this.enfe;
        }

        public getStormReceiver_result setEnfe(org.wso2.carbon.event.processor.storm.common.manager.service.exception.EndpointNotFoundException enfe) {
            this.enfe = enfe;
            return this;
        }
            ...
            switch (field) {
                ...
                case ENFE:
                    if (value == null) {
                        ...
                        setEnfe((org.wso2.carbon.event.processor.storm.common.manager.service.exception.EndpointNotFoundException)value);
                    }
                    break;
        ...
        public void read(org.apache.thrift.protocol.TProtocol iprot) throws org.apache.thrift.TException {
            ...
            while (true)
            {
                ...
                switch (field.id) {
                    ...
                    case 2: // ENFE
                        if (field.type == org.apache.thrift.protocol.TType.STRUCT) {
                            this.enfe = new org.wso2.carbon.event.processor.storm.common.manager.service.exception.EndpointNotFoundException();
    ...
    public static class getCEPPublisher_result implements org.apache.thrift.TBase<getCEPPublisher_result, getCEPPublisher_result._Fields>, java.io.Serializable, Cloneable   {
        ...
        public getCEPPublisher_result setNsme(org.wso2.carbon.event.processor.storm.common.manager.service.exception.NotStormManagerException nsme) {
            this.nsme = nsme;
            return this;
        }
        ...
        public getCEPPublisher_result setEnfe(org.wso2.carbon.event.processor.storm.common.manager.service.exception.EndpointNotFoundException enfe) {
            this.enfe = enfe;
            return this;
        }
