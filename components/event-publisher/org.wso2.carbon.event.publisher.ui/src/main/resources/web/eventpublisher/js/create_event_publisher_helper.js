...
function addEvent(form) {
    ...
    new Ajax.Request('../eventpublisher/addtest_event_ajaxprocessor.jsp', {
        method:'POST',
        asynchronous:false,
...
function testConnection(form) {
    ...
    var selectedIndex = document.getElementById("eventTypeFilter").selectedIndex;
    var selected_text = document.getElementById("eventTypeFilter").options[selectedIndex].text;
    var eventPublisherName = (document.getElementById("eventNameId").value.trim());
    if (eventPublisherName != "") {
        var testConnectionEnabled = "true";
        // ajax call for creating a event publisher at backend, needed parameters are appended.

        new Ajax.Request('../eventpublisher/addtest_event_ajaxprocessor.jsp', {
            method:'POST',
            asynchronous:false,
            parameters:{eventName:eventPublisherName, eventType:selected_text,
            ...
            onSuccess:function (msg) {
                if ("true" == msg.responseText.trim()) {
                    ...
                    CARBON.showWarningDialog("Test connection not implemented for this publisher");
...
function showEventProperties(propertiesHeader) {
    ...
    jQuery.ajax({
                    type:"POST",
                    url:"../eventpublisher/get_properties_ajaxprocessor.jsp?eventType=" + selected_text + "",
                    data:{},
                    ...
                    success:function (msg) {
                        if (msg != null) {
                            ...
                            var outputEventProperties = jsonObject.localEventPublisherPropertyDtos;
