...
public class EventPublisherConfigurationFilesystemInvoker {
    ...
    public static void save(OMElement eventFormatterOMElement,
        ...
        EventPublisherConfigurationFilesystemInvoker.save(eventFormatterOMElement.toString(), fileName, axisConfiguration);
    }
    ...
    public static void delete(String fileName,
        ...
        try {
            ...
            throw new EventPublisherConfigurationException("Error while deleting the Event Formatter : " + e.getMessage(), e);
        }
    }
    ...
    public static String readEventFormatterConfigurationFile(String fileName,
        ...
        try {
            ...
            throw new EventPublisherConfigurationException("Cannot read the Event Formatter file : " + e.getMessage(), e);
        } finally {
            try {
