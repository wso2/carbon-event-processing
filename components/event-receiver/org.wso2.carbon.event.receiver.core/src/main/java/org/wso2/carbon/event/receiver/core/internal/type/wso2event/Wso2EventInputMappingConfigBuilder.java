...
public class Wso2EventInputMappingConfigBuilder {
    ...
    private static Wso2EventInputMappingConfigBuilder instance = new Wso2EventInputMappingConfigBuilder();

    private Wso2EventInputMappingConfigBuilder() {

    }

    public static Wso2EventInputMappingConfigBuilder getInstance() {
        return Wso2EventInputMappingConfigBuilder.instance;
    }
