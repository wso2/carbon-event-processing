...
public class WebsocketEventAdapter extends AbstractOutputEventAdapter {
    ...
    private static WebsocketEventAdapter instance = new WebsocketEventAdapter();

    public static WebsocketEventAdapter getInstance() {
        return instance;
    }
    ...
    protected void publish(
            ...
            int tenantId) {
        String topic = outputAdaptorConfiguration.getEndpointAdaptorProperties().get(WebsocketEventAdaptorConstants.ADAPTER_TOPIC);
        String socketServerUrl = outputAdaptorConfiguration.getEndpointAdaptorProperties().get(WebsocketEventAdaptorConstants.ADAPTER_SERVER_URL);
        if (!socketServerUrl.startsWith("ws://")) {
            throw new EndpointAdaptorProcessingException("Provided websocket URL - " + socketServerUrl + " is invalid.");
        }
        if (topic != null) {
