...
public class WSO2OutputMapperFactory implements OutputMapperFactory {
    ...
    public OutputMapper constructOutputMapper(
            ...
            StreamDefinition streamDefinition) throws EventNotifierConfigurationException {
        return new WSO2EventOutputMapper(eventNotifierConfiguration, propertiesPositionMap, tenantId, streamDefinition);
    }
}
