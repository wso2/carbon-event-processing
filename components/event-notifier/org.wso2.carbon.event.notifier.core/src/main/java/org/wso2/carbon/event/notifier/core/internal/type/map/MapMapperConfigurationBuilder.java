...
public class MapMapperConfigurationBuilder {
    ...
    public static OutputMapping fromOM(
        ...
        if (customMappingEnabled == null || (customMappingEnabled.equals(EventNotifierConstants.TM_VALUE_ENABLE))) {
            ...
            if (!validateMapEventMapping(mappingElement)) {
                throw new EventNotifierConfigurationException("Map Mapping is not valid, check the output mapping");
            }

            if (mappingElement != null) {
                Iterator propertyIterator = mappingElement.getChildrenWithName(new QName(EventNotifierConstants.EF_CONF_NS, EventNotifierConstants.EF_ELE_PROPERTY));
    ...
    private static boolean validateMapEventMapping(OMElement omElement) {
        ...
        while (mappingIterator.hasNext()) {
            ...
            if (!childTag.equals(EventNotifierConstants.EF_ELE_PROPERTY)) {
                return false;
            }
            count++;
        }
    ...
    public static OMElement outputMappingToOM(
        ...
        mappingOMElement.addAttribute(EventNotifierConstants.EF_ATTR_TYPE, EventNotifierConstants.EF_MAP_MAPPING_TYPE, null);
