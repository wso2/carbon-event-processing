...
public class WSO2EventOutputMapperFactory implements OutputMapperFactory {
    ...
    public OutputMapper constructOutputMapper(
        ...
        return new WSO2EventOutputMapper(eventPublisherConfiguration, propertiesPositionMap, tenantId, streamDefinition);
    }
}
