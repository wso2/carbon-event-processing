...
//    private Map<Integer, Map<String, EndpointAdaptorConfiguration>> tenantSpecificEventAdaptorConfigurationMap;
...
//        tenantSpecificEventAdaptorConfigurationMap = new ConcurrentHashMap<Integer, Map<String, EndpointAdaptorConfiguration>>();
...
//            EndpointAdaptorConfiguration eventAdaptorConfiguration,
...
//        } else {
//            log.error("There is no Output Event Adaptor type called " + eventAdaptorConfiguration.getEndpointType() + " is available");
//            throw new OutputEventAdaptorManagerConfigurationException("There is no Output Event Adaptor type called " + eventAdaptorConfiguration.getEndpointType() + " is available ");
//        }
//    }
//
//    @Override
...
//
//    @Override
//    public List<EndpointAdaptorConfiguration> getAllActiveOutputEventAdaptorConfiguration(
//            AxisConfiguration axisConfiguration)
//            throws OutputEventAdaptorManagerConfigurationException {
//
//        List<EndpointAdaptorConfiguration> eventAdaptorConfigurations = new ArrayList<EndpointAdaptorConfiguration>();
//        int tenantId = PrivilegedCarbonContext.getThreadLocalCarbonContext().getTenantId();
//        if (tenantSpecificEventAdaptorConfigurationMap.get(tenantId) != null) {
//            for (EndpointAdaptorConfiguration eventAdaptorConfiguration : tenantSpecificEventAdaptorConfigurationMap.get(
//                    tenantId).values()) {
...
//
//    @Override
//    public EndpointAdaptorConfiguration getActiveOutputEventAdaptorConfiguration(
//            String name,
//            int tenantId)
//            throws OutputEventAdaptorManagerConfigurationException {
//
...
//            omElement.build();
//            EndpointAdaptorConfiguration eventAdaptorConfigurationObject = OutputEventAdaptorConfigurationHelper.fromOM(omElement);
...
//                } else {
//                    log.error("There is no Output Event Adaptor type called " + eventAdaptorConfigurationObject.getEndpointType() + " is available");
//                    throw new OutputEventAdaptorManagerConfigurationException("There is no Output Event Adaptor type called " + eventAdaptorConfigurationObject.getEndpointType() + " is available ");
//                }
//            } else {
...
//
//        int tenantId = PrivilegedCarbonContext.getThreadLocalCarbonContext().getTenantId();
//        EndpointAdaptorConfiguration endpointAdaptorConfiguration = getActiveOutputEventAdaptorConfiguration(eventAdaptorName, tenantId);
//        endpointAdaptorConfiguration.setEnableStatistics(flag);
//        editTracingStatistics(endpointAdaptorConfiguration, eventAdaptorName, tenantId, axisConfiguration);
//    }
//
//    @Override
...
//        int tenantId = PrivilegedCarbonContext.getThreadLocalCarbonContext().getTenantId();
//        EndpointAdaptorConfiguration endpointAdaptorConfiguration = getActiveOutputEventAdaptorConfiguration(eventAdaptorName, tenantId);
//        endpointAdaptorConfiguration.setEnableTracing(flag);
//        editTracingStatistics(endpointAdaptorConfiguration, eventAdaptorName, tenantId, axisConfiguration);
//    }
//
//    @Override
//    public void registerDeploymentPublisher(
...
//
//    @Override
//    public String getDefaultLoggerEventAdaptor(AxisConfiguration axisConfiguration)
//            throws OutputEventAdaptorManagerConfigurationException {
//        int tenantId = PrivilegedCarbonContext.getThreadLocalCarbonContext().getTenantId();
//        Map<String, OutputEventAdaptorInfo> outputEventAdaptorInfoMap = tenantSpecificOutputEventAdaptorInfoMap.get(tenantId);
//        if (outputEventAdaptorInfoMap != null) {
//            OutputEventAdaptorInfo defaultOutputEventAdaptorInfo = outputEventAdaptorInfoMap.get(OutputEventAdaptorManagerConstants.DEFAULT_LOGGER_OUTPUT_ADAPTOR);
//            if (defaultOutputEventAdaptorInfo != null && defaultOutputEventAdaptorInfo.getEventAdaptorType().equals(OutputEventAdaptorManagerConstants.ADAPTOR_TYPE_LOGGER)) {
//                return outputEventAdaptorInfoMap.get(OutputEventAdaptorManagerConstants.DEFAULT_LOGGER_OUTPUT_ADAPTOR).getEventAdaptorName();
//            }
//        }
//
...
//            int tenantId, EndpointAdaptorConfiguration eventAdaptorConfiguration)
//            throws OutputEventAdaptorManagerConfigurationException {
//        Map<String, EndpointAdaptorConfiguration> eventAdaptorConfigurationMap =
...
//            eventAdaptorConfigurationMap = new ConcurrentHashMap<String, EndpointAdaptorConfiguration>();
...
//        OMElement omElement = OutputEventAdaptorConfigurationHelper.eventAdaptorConfigurationToOM(endpointAdaptorConfiguration);
//        OutputEventAdaptorConfigurationFilesystemInvoker.delete(fileName, axisConfiguration);
...
//                                              OMElement omElement)
//            throws OutputEventAdaptorManagerConfigurationException {
//        EndpointAdaptorConfiguration eventAdaptorConfiguration = OutputEventAdaptorConfigurationHelper.fromOM(omElement);
