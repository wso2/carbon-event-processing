...
public class StormProcessorDeployer extends AbstractDeployer {

    private static Log log = LogFactory.getLog(StormProcessorDeployer.class);
    ...
    public synchronized void processDeploy(DeploymentFileData deploymentFileData)
        ...
        CarbonStormProcessorService carbonStormProcessorService = StormProcessorValueHolder.getStormProcessorService();
        ...
        try {
            ...
            carbonStormProcessorService.addExecutionPlanConfiguration(executionPlanConfiguration, configurationContext.getAxisConfiguration());
            ...
            carbonStormProcessorService.addExecutionPlanConfigurationFile(executionPlanConfigurationFile, PrivilegedCarbonContext.getThreadLocalCarbonContext().getTenantId());
            ...
            log.error("Execution plan is not deployed and in inactive state : " + executionPlanFile.getName() + ", " + ex.getMessage());
            ...
            log.error("Execution plan is not deployed and in inactive state : " + executionPlanConfigurationFile.getFileName() + ", " + ex.getMessage());
            throw new ExecutionPlanConfigurationException(ex.getMessage(), ex);
        }
    ...
    public synchronized void processUndeploy(String filePath) {
        ...
        int tenantId = PrivilegedCarbonContext.getThreadLocalCarbonContext().getTenantId();
        CarbonStormProcessorService carbonEventProcessorService = StormProcessorValueHolder.getStormProcessorService();
