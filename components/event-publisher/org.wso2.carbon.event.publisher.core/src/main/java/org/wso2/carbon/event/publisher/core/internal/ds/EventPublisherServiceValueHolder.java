...
import org.wso2.carbon.event.publisher.core.internal.type.wso2event.WSO2OutputMapperFactory;
...
public class EventPublisherServiceValueHolder {
    ...
    public static void registerOutputEventAdaptorService(CarbonOutputEventAdaptorService carbonOutputEventAdaptorService) {
        EventPublisherServiceValueHolder.carbonOutputEventAdaptorService = carbonOutputEventAdaptorService;
    }
}
