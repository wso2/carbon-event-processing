...
/**
 * Output event message configuration details
 */
public class OutputEventAdaptorMessageConfiguration {
    ...
    public OutputEventAdaptorMessageConfiguration() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OutputEventAdaptorMessageConfiguration)) {
            return false;
        }

        OutputEventAdaptorMessageConfiguration that = (OutputEventAdaptorMessageConfiguration) o;
