...
import org.wso2.carbon.event.execution.manager.core.internal.structure.template.ObjectFactory;
import org.wso2.carbon.event.execution.manager.core.internal.structure.domain.Template;
import org.wso2.carbon.event.execution.manager.core.internal.structure.domain.TemplateDomain;
import org.wso2.carbon.event.execution.manager.core.internal.structure.template.TemplateConfig;
...
/*
  class reads template domain structures and template configuration structures using JAXB and return each class object
 */
public class ReadTemplateStructures {
    ...
    public TemplateConfig getTemplateConfig(String fileContent) throws JAXBException {
        ...
        JAXBElement<TemplateConfig> unmarshalledObject =
                ((JAXBElement<TemplateConfig>) unmarshaller.unmarshal(
        ...
        JAXBElement<TemplateDomain> unmarshalledObject =
                ((JAXBElement<TemplateDomain>) unmarshaller
                        .unmarshal(new ByteArrayInputStream(
                                fileContent.getBytes(Charset.forName(ExecutionManagerConstants.DEFAULT_CHARSET)))));
