...
public class EventFormatterConfigurationHelper {
    ...
    public static String getEventFormatterName(OMElement eventFormatterOMElement) {
        return eventFormatterOMElement.getAttributeValue(new QName(EventFormatterConstants.EF_ATTR_NAME));
    }
