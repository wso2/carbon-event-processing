...
public class SiddhiTransactionalBolt extends BaseBatchBolt {
    private static transient Logger log = Logger.getLogger(SiddhiTransactionalBolt.class);
    ...
    public SiddhiTransactionalBolt() {
        init();
    }

    public SiddhiTransactionalBolt(String executionPlan, InputHandler inputHandler, String[] exportedStreams) {
    ...
    public BatchOutputCollector getCollector() {
        return collector;
    }
    ...
    @Override
    public void prepare(Map stormConf, TopologyContext topologyContext, BatchOutputCollector batchOutputCollector, Object obj) {
