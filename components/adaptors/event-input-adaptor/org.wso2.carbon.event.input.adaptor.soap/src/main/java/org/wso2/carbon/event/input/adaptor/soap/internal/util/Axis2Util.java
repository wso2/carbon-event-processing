...
public final class Axis2Util {
    ...
    public static AxisService registerAxis2Service(
        ...
        String topicNameWithoutSlash = inputEventMessageConfiguration.getInputMessageProperties().get(SoapEventAdaptorConstants.ADAPTOR_MESSAGE_OPERATION_NAME).replaceAll("/", "");
    ...
    public static void removeOperation(
        ...
        if (messageReceiver.removeEventAdaptorListener(subscriptionId)) {
            axisService.removeOperation(new QName("", inputEventMessageConfiguration.getInputMessageProperties().get(SoapEventAdaptorConstants.ADAPTOR_MESSAGE_OPERATION_NAME).replaceAll("/", "")));
        }
