...
<fmt:bundle basename="org.wso2.carbon.event.stream.manager.ui.i18n.Resources">
    ...
    <div id="middle">
        <h2><fmt:message key="title.event.in.flow"/> (<a
        ...
        <div id="workArea">
            ...
            <table style="width:100%" id="inFlowDetails" class="styledLeft">
                ...
                <tr>
                    <td class="formRaw">
                        <p><b><fmt:message key="internal.event.inflows"/></b></p>
                        <jsp:include page="../eventbuilder/event_builder_inFlows.jsp" flush="true">
                            <jsp:param name="eventStreamWithVersion"
                                       value="<%=eventStreamWithVersion%>"/>
                        </jsp:include>
                        <p><b><fmt:message key="external.event.inflows"/></b></p>
