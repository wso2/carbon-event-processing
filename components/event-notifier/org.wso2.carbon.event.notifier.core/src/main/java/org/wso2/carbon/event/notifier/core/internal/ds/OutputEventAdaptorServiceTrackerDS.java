 ...
 * interface="org.wso2.carbon.event.notifier.core.OutputEventAdaptorFactory" cardinality="0..n"
...
public class OutputEventAdaptorServiceTrackerDS {
    ...
    protected void unSetEventAdaptorType(
            OutputEventAdaptorFactory outputEventAdaptorFactory) {
        ((CarbonOutputEventAdaptorService) EventNotifierServiceValueHolder.getOutputEventAdaptorService()).unRegisterEventAdaptor(outputEventAdaptorFactory.getEventAdaptor());
    }
}
