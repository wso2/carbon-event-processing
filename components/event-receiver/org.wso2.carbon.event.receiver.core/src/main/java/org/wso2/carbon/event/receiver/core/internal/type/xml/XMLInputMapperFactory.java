...
public class XMLInputMapperFactory implements InputMapperFactory {
    ...
    public InputMapping constructInputMappingFromOM(OMElement omElement)
        ...
        return XMLInputMapperConfigrationBuilder.getInstance().fromOM(omElement);
    }

    @Override
    public OMElement constructOMFromInputMapping(
            InputMapping inputMapping, OMFactory factory) {
        return XMLInputMapperConfigrationBuilder.getInstance().inputMappingToOM(inputMapping, factory);
    }
    ...
    public InputMapper constructInputMapper(EventReceiverConfiguration eventReceiverConfiguration,
            ...
            throws EventReceiverConfigurationException {
        return new XMLInputMapper(eventReceiverConfiguration, exportedStreamDefinition);
    }
}
