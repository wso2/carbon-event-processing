    ...
    <table class="styledLeft">
        ...
        <tr>
            ...
            <td>
                ...
                <% } %>
                <%--<a style="background-image: url(../inputeventadaptormanager/images/activate.gif);"--%>
                   <%--class="icon-link"--%>
                   <%--onclick="deactivateInputEventAdaptor('<%=eventDetails.getEventAdaptorName()%>')"><font--%>
                        <%--color="#4682b4">Deactivate</font></a>--%>
