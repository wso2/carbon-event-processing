...
<%
    ...
    if (eventType != null) {
        ...
        EventPublisherPropertyDto[] eventPublisherPropertyDtos = stub.getEventPublisherAdaptorProperties(eventType);
        String propertiesString = "";
        propertiesString = new Gson().toJson(eventPublisherPropertyDtos);
