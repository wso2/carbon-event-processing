...
public class InputEventAdaptorManagerAdminService extends AbstractAdmin {
    ...
    //TODO --> remove the wrapper and send as array
    ...
    public String[] getSupportedInputMappingTypes(String inputEventAdaptorName) throws AxisFault {
        ...
        InputEventAdaptorService eventAdaptorService = InputEventAdaptorHolder.getInstance().getEventAdaptorService();
        InputEventAdaptorManagerService inputEventAdaptorManagerService = InputEventAdaptorManagerHolder.getInstance().getInputEventAdaptorManagerService();
        String eventAdaptorType = null;
        try {
            InputEventAdaptorConfiguration inputEventAdaptorConfiguration =
                    inputEventAdaptorManagerService.getActiveInputEventAdaptorConfiguration(inputEventAdaptorName, tenantId);
        ...
        if (eventAdaptorType != null) {
            InputEventAdaptorDto eventAdaptorDto = eventAdaptorService.getEventAdaptorDto(eventAdaptorType);
            if (eventAdaptorDto != null) {
                supportedInputMappingTypes = eventAdaptorDto.getSupportedMessageTypes();
            }
        }
        if (supportedInputMappingTypes != null) {
            return supportedInputMappingTypes.toArray(new String[supportedInputMappingTypes.size()]);
        }else {
            throw new AxisFault("There is no any supported mapping types defined for adaptor");
        }
    }
