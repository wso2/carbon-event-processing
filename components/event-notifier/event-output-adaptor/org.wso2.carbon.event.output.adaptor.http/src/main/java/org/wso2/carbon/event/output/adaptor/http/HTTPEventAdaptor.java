...
public class HTTPEventAdaptor extends AbstractOutputEventAdaptor {
    ...
    private void checkHTTPClientInit(
        ...
        synchronized (HTTPEventAdaptor.class) {
            ...
            Map<String, String> props = endpointAdaptorConfiguration.getOutputAdaptorProperties();
    ...
    public void publish(
        ...
        this.checkHTTPClientInit(endpointAdaptorConfiguration);
        Map<String, String> messageProps = endpointAdaptorConfiguration.getOutputAdaptorProperties();
    ...
    @Override
    public void testConnection(EndpointAdaptorConfiguration
                                       endpointAdaptorConfiguration, int tenantId) {

        Map<String, String> adaptorProps = endpointAdaptorConfiguration.getOutputAdaptorProperties();
