 ...
 * interface="org.wso2.carbon.event.receiver.core.InputEventAdaptorFactory" cardinality="0..n"
    ...
    protected void activate(ComponentContext context) {
        try {
            if (log.isDebugEnabled()) {
                log.debug("Successfully deployed the input event adaptor tracker service");
            }
