...
public final class KafkaEventAdaptorType extends AbstractOutputEventAdaptor {
    ...
    @Override
    public void publish(
            Object event, EndpointAdaptorConfiguration endpointAdaptorConfiguration,
            int tenantId) {
        Map<String, String> brokerProperties = endpointAdaptorConfiguration.getOutputAdaptorProperties();
        String kafkaConnect = brokerProperties.get(KafkaOutEventAdaptorConstants.ADAPTOR_META_BROKER_LIST);

        Map<String, String> messageProperties = endpointAdaptorConfiguration.getOutputAdaptorProperties();
