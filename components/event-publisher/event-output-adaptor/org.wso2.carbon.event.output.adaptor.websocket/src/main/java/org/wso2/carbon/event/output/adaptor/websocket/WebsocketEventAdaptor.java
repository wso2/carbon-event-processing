...
public class WebsocketEventAdaptor extends AbstractOutputEventAdaptor {
    ...
    protected void publish(
            ...
            int tenantId) {
        String topic = endpointAdaptorConfiguration.getOutputAdaptorProperties().get(WebsocketEventAdaptorConstants.ADAPTER_TOPIC);
        String socketServerUrl = endpointAdaptorConfiguration.getOutputAdaptorProperties().get(WebsocketEventAdaptorConstants.ADAPTER_SERVER_URL);
