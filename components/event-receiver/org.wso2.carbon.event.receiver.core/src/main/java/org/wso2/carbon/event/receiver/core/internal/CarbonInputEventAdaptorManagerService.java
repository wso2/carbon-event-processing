...
//import org.wso2.carbon.event.input.adaptor.manager.core.*;
//import org.wso2.carbon.event.receiver.core.InputEventAdaptorInfo;
//import org.wso2.carbon.event.receiver.core.InputEventAdaptorManagerService;
//import org.wso2.carbon.event.receiver.core.InputEventAdaptorNotificationListener;
...
//
//    @Override
//    public String getDefaultWso2EventAdaptor(AxisConfiguration axisConfiguration)
//            throws InputEventAdaptorManagerConfigurationException {
//        int tenantId = PrivilegedCarbonContext.getThreadLocalCarbonContext().getTenantId();
//        Map<String, InputEventAdaptorInfo> inputEventAdaptorInfoMap = tenantSpecificInputEventAdaptorInfoMap.get(tenantId);
//        if (inputEventAdaptorInfoMap != null) {
...
//
//    @Override
//    public String getDefaultWso2EventAdaptor()
//            throws InputEventAdaptorManagerConfigurationException {
//        int tenantId = PrivilegedCarbonContext.getThreadLocalCarbonContext().getTenantId();
//        Map<String, InputEventAdaptorInfo> inputEventAdaptorInfoMap = tenantSpecificInputEventAdaptorInfoMap.get(tenantId);
//        if (inputEventAdaptorInfoMap != null) {
