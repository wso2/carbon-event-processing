...
import org.wso2.carbon.event.execution.manager.DomainInfoDTO;
import org.wso2.carbon.event.execution.manager.internal.structure.template.ObjectFactory;
import org.wso2.carbon.event.execution.manager.internal.structure.template.TemplateDomain;
                ...
                if (fileEntry.isFile()) {
                    ...
                    //create a TemplateDomain object from the unmarsheller
                            ...
                            ((JAXBElement<TemplateDomain>) unmarshaller
                                    .unmarshal(new ByteArrayInputStream(fileContent.getBytes(Charset.forName("UTF-8")
                    ))));
