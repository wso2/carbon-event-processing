...
* under the License.
*/
package org.wso2.carbon.event.notifier.ui;
...
import org.wso2.carbon.event.notifier.stub.EventNotifierAdminServiceStub;
...
public class EventNotifierUIUtils {

    public static EventNotifierAdminServiceStub getEventNotifierAdminService(
        ...
        String serverURL = CarbonUIUtil.getServerURL(config.getServletContext(),
                session) + "EventNotifierAdminService.EventNotifierAdminServiceHttpsSoap12Endpoint";
        EventNotifierAdminServiceStub stub = new EventNotifierAdminServiceStub(configContext, serverURL);
