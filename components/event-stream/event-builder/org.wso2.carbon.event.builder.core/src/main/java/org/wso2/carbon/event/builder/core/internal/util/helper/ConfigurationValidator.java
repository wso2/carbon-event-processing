...
public class ConfigurationValidator {
    ...
    public static boolean validateInputEventAdaptor(String inputEventAdaptorName,
                                                    String inputEventAdaptorType, int tenantId) throws EventBuilderConfigurationException {
        ...
        try {
            ...
            throw new EventBuilderConfigurationException("Exception when retrieving configuration for InputEventAdaptor '" + inputEventAdaptorName + "'.", e);
        }
        throw new EventBuilderValidationException("Input event adaptor :" + inputEventAdaptorName + " does not exist.", inputEventAdaptorName);
