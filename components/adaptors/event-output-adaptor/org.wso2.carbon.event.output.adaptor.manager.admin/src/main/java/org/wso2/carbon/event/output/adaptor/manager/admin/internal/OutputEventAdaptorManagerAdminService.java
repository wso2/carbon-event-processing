...
public class OutputEventAdaptorManagerAdminService extends AbstractAdmin {
        ...
        try {
            ...
            if (eventAdaptorConfigurationList != null) {
                ...
                for (int index = 0; index < outputEventAdaptorConfigurationInfoDtoArray.length; index++) {
                    ...
                    outputEventAdaptorConfigurationInfoDtoArray[index].setEditable(eventAdaptorConfiguration.isEditable());
                }
    ...
    public String[] getSupportedMappingTypes(String eventAdaptorName) throws AxisFault {
        ...
        OutputEventAdaptorManagerService eventAdaptorManagerService = OutputEventAdaptorManagerHolder.getInstance().getOutputEventAdaptorManagerService();
    ...
    //TODO use a array object instead of wrapper
