...
/**
 * This class is used to wrap the input event adaptor configuration
 */
public class InternalInputEventAdaptorConfiguration {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InternalInputEventAdaptorConfiguration)) {
            return false;
        }

        InternalInputEventAdaptorConfiguration that = (InternalInputEventAdaptorConfiguration) o;
