...
public class EventBuilderConfigBuilder {
    ...
    public static OMElement eventBuilderConfigurationToOM(
        ...
        InputEventAdaptorConfiguration inputEventAdaptorConfiguration = eventBuilderConfiguration.getInputEventAdaptorConfiguration();
        ...
        fromOMElement.addAttribute(EventBuilderConstants.EB_ATTR_TA_TYPE, inputEventAdaptorConfiguration.getInputEventAdaptorType(), null);
    ...
    public static EventBuilderConfiguration getEventBuilderConfiguration(
        ...
        InputEventAdaptorConfiguration inputEventAdaptorConfiguration = EventBuilderConfigHelper.getInputEventAdaptorConfiguration(fromEventAdaptorType);
        inputEventAdaptorConfiguration.setInputEventAdaptorName(eventBuilderName);
        ...
        eventBuilderConfiguration.setInputEventAdaptorConfiguration(inputEventAdaptorConfiguration);
