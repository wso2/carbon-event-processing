...
import org.wso2.carbon.event.receiver.core.internal.type.JSONInputMapper;
...
public class JSONInputMapperFactory implements InputMapperFactory {
    ...
    public OMElement constructOMFromInputMapping(
        ...
        return JSONInputMapperConfigurationBuilder.getInstance().inputMappingToOM(inputMapping, factory);
    }
