...
* under the License.
*/
package org.wso2.carbon.event.publisher.admin.internal.util;
...
public class EventPublisherAdminServiceValueHolder {
    ...
    public static void registerEventAdaptorService(
        ...
        EventPublisherAdminServiceValueHolder.outputEventAdaptorService = eventAdaptorService;
    }

    public static OutputEventAdaptorService getOutputEventAdaptorService() {
        return EventPublisherAdminServiceValueHolder.outputEventAdaptorService;
    }

    public static void registerPublisherService(
