 ...
 */
public class HTTPEventAdapter extends AbstractOutputEventAdapter {

    private static HTTPEventAdapter instance = new HTTPEventAdapter();
    ...
    private Log log = LogFactory.getLog(HTTPEventAdapter.class);

    private HTTPEventAdapter() {
    }
    ...
    private void checkHTTPClientInit(
        ...
        synchronized (HTTPEventAdapter.class) {
            ...
            Map<String, String> props = outputAdaptorConfiguration.getEndpointAdaptorProperties();
    ...
    public void publish(
        ...
        this.checkHTTPClientInit(outputAdaptorConfiguration);
        Map<String, String> messageProps = outputAdaptorConfiguration.getEndpointAdaptorProperties();
    ...
    @Override
    public void testConnection(OutputAdaptorConfiguration
                                           outputAdaptorConfiguration, int tenantId) {

        Map<String, String> adaptorProps = outputAdaptorConfiguration.getEndpointAdaptorProperties();
        ...
        if (adaptorProps != null) {
            if (adaptorProps.get(HTTPEventAdaptorConstants.ADAPTER_PROXY_HOST) != null && adaptorProps.get(HTTPEventAdaptorConstants.ADAPTER_PROXY_PORT) != null) {
                ...
                throw new EndpointAdaptorProcessingException("Necessary host and/or port values are not found to check the connection");
            }
        }
    }
