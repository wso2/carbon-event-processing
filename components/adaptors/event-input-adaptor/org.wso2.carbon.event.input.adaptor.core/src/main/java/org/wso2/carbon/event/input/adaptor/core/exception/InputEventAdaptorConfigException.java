...
public class InputEventAdaptorConfigException extends Exception {
    ...
    public InputEventAdaptorConfigException(String message) {
        super(message);
    }

    public InputEventAdaptorConfigException(String message, Throwable cause) {
        super(message, cause);
    }

    public InputEventAdaptorConfigException(Throwable cause) {
        super(cause);
    }
}
