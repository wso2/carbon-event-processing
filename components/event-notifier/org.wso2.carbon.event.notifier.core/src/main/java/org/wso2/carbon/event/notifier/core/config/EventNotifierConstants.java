...
public final class EventNotifierConstants {

    public static final String NORMALIZATION_STRING = "_";
    public static final String EF_CONF_NS = "http://wso2.org/carbon/eventnotifier";
    public static final String EF_ELE_ROOT_ELEMENT = "eventNotifier";
    public static final String TM_ELE_DIRECTORY = "eventnotifiers";
    ...
    public static final String EF_ELE_ENDPOINT_PROPERTY = "endpoint";
    ...
    public static final String EVENT_NOTIFIER = "Event Notifier";
    ...
    public static final String DEFAULT_EVENT_NOTIFIER_POSTFIX = "_notifier";
    ...
    public static final String NO_DEPENDENCY_INFO_MSG = "No dependency information available for this event notifier";
    ...
    private EventNotifierConstants() {
    }
}