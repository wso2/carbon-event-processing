...
//import org.wso2.carbon.event.output.adaptor.manager.core.internal.util.helper.*;
//
...
//            String xmlContent = new org.wso2.carbon.event.output.adaptor.manager.core.internal.util.helper.XmlFormatter().format(eventAdaptorConfig);
