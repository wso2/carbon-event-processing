...
public class MQTTAdaptorPublisher {
    ...
    public void publish(int qos, String payload) throws EndpointAdaptorProcessingException {
        try {
    ...
    public void publish(String payload) throws EndpointAdaptorProcessingException {
        try {
            // Create and configure a message
            MqttMessage message = new MqttMessage(payload.getBytes());
            mqttClient.publish(topic, message);
    ...
    public void close() throws EndpointAdaptorProcessingException {
        try {
