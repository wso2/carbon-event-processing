...
public class JMSConnectionFactory {
    ...
    public JMSConnectionFactory(Hashtable<String, String> parameters, String name) {
        ...
        try {
            ...
            throw new OutputEventAdaptorEventProcessingException("Cannot acquire JNDI context, JMS Connection factory : " +
    ...
    private void digestCacheLevel() {
        ...
        if ("none".equalsIgnoreCase(val)) {
            ...
            throw new OutputEventAdaptorEventProcessingException("Invalid cache level : " + val + " for JMS CF : " + name);
        }
    }
    ...
    private void handleException(String msg, Exception e) {
        log.error(msg, e);
        throw new OutputEventAdaptorEventProcessingException(msg, e);
    }
    ...
    public Boolean isQueue() {
        ...
        if (parameters.get(JMSConstants.PARAM_CONFAC_TYPE) != null) {
            if ("queue".equalsIgnoreCase(parameters.get(JMSConstants.PARAM_CONFAC_TYPE))) {
                ...
                throw new OutputEventAdaptorEventProcessingException("Invalid " + JMSConstants.PARAM_CONFAC_TYPE + " : " +
            ...
            if ("queue".equalsIgnoreCase(parameters.get(JMSConstants.PARAM_DEST_TYPE))) {
                ...
                throw new OutputEventAdaptorEventProcessingException("Invalid " + JMSConstants.PARAM_DEST_TYPE + " : " +
