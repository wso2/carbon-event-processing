...
public class StormConfigReader {
    ...
    private static Logger log = Logger.getLogger(StormConfigReader.class);
    private static final String CONFIG_FILE_NAME = "storm-deployment-config.xml";

    public static StormDeploymentConfig loadConfigurations(String carbonHome) {
        String path = carbonHome + File.separator + "repository" + File.separator + "conf" + File.separator + CONFIG_FILE_NAME;
