...
import org.wso2.carbon.event.receiver.core.internal.util.helper.EventBuilderConfigurationFileSystemInvoker;
...
//                        //eventBuilderConfiguration.getInputEventAdaptorConfiguration().getInputEventAdaptorName().equals(defaultWso2EventAdaptorName) &&
...
//                    for (EventBuilder eventBuilder : eventBuilderList) {
//                        if (eventBuilder.getEventBuilderConfiguration().getInputEventAdaptorConfiguration().getInputEventAdaptorType().equals(inputEventAdaptorConfiguration.getName())) {
