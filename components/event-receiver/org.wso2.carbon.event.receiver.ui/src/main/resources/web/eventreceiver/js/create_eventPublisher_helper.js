...
function loadEventAdapterMessageProperties(messageProperty, eventReceiverInputTable, propertyLoop,
...
function showEventStreamDefinition() {
    ...
    jQuery.ajax({
                    type:"POST",
                    url:"../eventreceiver/get_streamdefinition_ajaxprocessor.jsp?streamName=" + selected_text + "",
                    data:{},
...
function loadEventAdapterRelatedProperties(toPropertyHeader) {
    ...
    jQuery.ajax({
                    type:"POST",
                    url:"../eventreceiver/get_mappings_ajaxprocessor.jsp?eventAdapterType=" + selected_text + "",
                    data:{},
                    contentType:"application/json; charset=utf-8",
                    dataType:"text",
                    async:false,
...
// delete message properties related fields
    for (i = eventReceiverInputTable.rows.length - 5; i > 4; i--) {
        eventReceiverInputTable.deleteRow(i);
    }

    jQuery.ajax({
                    type:"POST",
                    url:"../eventreceiver/get_message_properties_ajaxprocessor.jsp?eventAdapterType=" + selected_text + "",
                    data:{},
                    contentType:"application/json; charset=utf-8",
                    dataType:"text",
                    async:false,
