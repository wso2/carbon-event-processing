...
public class WSO2OutputMapperFactory implements OutputMapperFactory {
    ...
    public OutputMapper constructOutputMapper(
            ...
            StreamDefinition streamDefinition) throws EventFormatterConfigurationException {
        return new WSO2EventOutputMapper(eventFormatterConfiguration, propertiesPositionMap, tenantId, streamDefinition);
    }
}
