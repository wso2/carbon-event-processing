...
import org.wso2.carbon.event.notifier.admin.internal.util.EventFormatterAdminServiceValueHolder;
...
import org.wso2.carbon.event.publisher.core.config.EventFormatterConstants;
import org.wso2.carbon.event.publisher.core.exception.EventFormatterConfigurationException;
import org.wso2.carbon.event.publisher.core.internal.config.EventOutputProperty;
import org.wso2.carbon.event.publisher.core.internal.config.ToPropertyConfiguration;
import org.wso2.carbon.event.publisher.core.internal.type.json.JSONOutputMapping;
import org.wso2.carbon.event.publisher.core.internal.type.map.MapOutputMapping;
import org.wso2.carbon.event.publisher.core.internal.type.text.TextOutputMapping;
import org.wso2.carbon.event.publisher.core.internal.type.wso2event.WSO2EventOutputMapping;
import org.wso2.carbon.event.publisher.core.internal.type.xml.XMLOutputMapping;
...
public class EventFormatterAdminService extends AbstractAdmin {
    ...
    public EventFormatterConfigurationInfoDto[] getAllStreamSpecificActiveEventFormatterConfiguration(
            String streamId)
            throws AxisFault {
    ...
    public EventFormatterConfigurationFileDto[] getAllInactiveEventFormatterConfiguration()
        ...
        if (eventFormatterConfigurationFileList != null) {
            ...
            for (int index = 0; index < eventFormatterFileDtoArray.length; index++) {
                ...
                eventFormatterFileDtoArray[index] = new EventFormatterConfigurationFileDto(fileName, eventFormatterName, statusMsg);
            }
    ...
    public EventFormatterPropertyDto[] getEventFormatterMessageProperties(String eventAdaptorName)
            throws AxisFault {
    ...
    public void deployEventFormatterConfiguration(String eventFormatterConfigXml)
            throws AxisFault {
        try {
            EventFormatterService eventFormatterService = EventFormatterAdminServiceValueHolder.getEventFormatterService();
            eventFormatterService.deployEventFormatterConfiguration(eventFormatterConfigXml, getAxisConfig());
        } catch (EventFormatterConfigurationException e) {
            log.error(e.getMessage(), e);
            throw new AxisFault(e.getMessage());
        }
        ...
        if (checkEventFormatterValidity(eventFormatterName)) {
            try {
                ...
                if (outputPropertyConfiguration != null && outputPropertyConfiguration.length != 0) {
                    ...
                    for (PropertyDto eventFormatterProperty : outputPropertyConfiguration) {
    ...
    public void deployDefaultEventSender(String streamId) throws AxisFault {
        ...
        AxisConfiguration axisConfiguration = getAxisConfig();
        try {
            eventFormatterService.deployDefaultEventSender(streamId, axisConfiguration);
        } catch (EventFormatterConfigurationException e) {
            log.error(e.getMessage(), e);
            throw new AxisFault(e.getMessage());
        }
