...
public class WSO2EventMapperConfigurationBuilder {
    ...
    private static EventOutputProperty getWSO2EventOutputPropertyFromOM(OMElement omElement) {
        ...
        OMElement propertyToElement = omElement.getFirstChildWithName(new QName(EventPublisherConstants.EF_CONF_NS, EventPublisherConstants.EF_ELE_ENDPOINT_PROPERTY));
    ...
    private static OMElement getPropertyOmElement(OMFactory factory,
        ...
        OMElement toElement = factory.createOMElement(new QName(EventPublisherConstants.EF_ELE_ENDPOINT_PROPERTY));
