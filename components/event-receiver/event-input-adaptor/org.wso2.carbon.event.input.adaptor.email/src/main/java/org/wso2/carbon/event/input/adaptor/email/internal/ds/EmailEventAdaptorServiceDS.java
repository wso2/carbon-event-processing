...
import org.wso2.carbon.event.input.adaptor.email.EmailEventAdaptorFactory;
import org.wso2.carbon.utils.ConfigurationContextService;


/**
 * @scr.component name="input.emailEventAdaptorService.component" immediate="true"
...
public class EmailEventAdaptorServiceDS {
    ...
    protected void activate(ComponentContext context) {
        ...
        try {
            InputEventAdaptorFactory emailEventAdaptorFactory = new EmailEventAdaptorFactory();
            context.getBundleContext().registerService(InputEventAdaptorFactory.class.getName(), emailEventAdaptorFactory, null);
