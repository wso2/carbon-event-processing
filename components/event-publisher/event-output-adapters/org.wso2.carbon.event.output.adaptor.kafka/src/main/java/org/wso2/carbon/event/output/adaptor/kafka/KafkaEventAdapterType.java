...
public final class KafkaEventAdapterType extends AbstractOutputEventAdapter {

    private static final Log log = LogFactory.getLog(KafkaEventAdapterType.class);
    private ResourceBundle resourceBundle;
    private static KafkaEventAdapterType kafkaAdaptor = new KafkaEventAdapterType();
    ...
    public static KafkaEventAdapterType getInstance() {
        return kafkaAdaptor;
    }
    ...
    @Override
    public void publish(
            Object event, OutputAdaptorConfiguration outputAdaptorConfiguration,
            int tenantId) {
        Map<String, String> brokerProperties = outputAdaptorConfiguration.getEndpointAdaptorProperties();
        String kafkaConnect = brokerProperties.get(KafkaOutEventAdaptorConstants.ADAPTOR_META_BROKER_LIST);

        Map<String, String> messageProperties = outputAdaptorConfiguration.getEndpointAdaptorProperties();
